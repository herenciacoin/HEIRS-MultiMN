...
# Author: herenciacoin
# Source: https://github.com/herenciacoin/HEIRS-MultiMN
...
function cmd_bootstrap() {
	...
	#For copied bootstrap data while new node installation // Ex. : multimn install herencia --bootstrap
...
function cmd_help() {
	echo -e "Options:\
			...
			\n**NOTE 2**: Check ${CYAN}https://github.com/herenciacoin/HEIRS-MultiMN/wiki/Commands${NC} for extended info and usage examples of each command.\
			\n**NOTE 3**: Check ${CYAN}https://github.com/herenciacoin/HEIRS-MultiMN/wiki/FAQs${NC} for technical questions and troubleshooting."
}
function cmd_update() {
	curl -sL https://raw.githubusercontent.com/herenciacoin/HEIRS-MultiMN/main/multimn_install.sh 3>&3 | bash
	exit
}
