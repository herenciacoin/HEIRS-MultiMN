...
echo -e "\n====================================================================================\
         ...
         \n   ${GRAY}██║ ╚═╝ ██║ ╚██████╔╝ ██████╗   ██║    ██████╗ ${NC}██║ ╚═╝ ██║██║ ╚████║  \
         \n   ${GRAY}╚═╝     ╚═╝  ╚═════╝  ╚═════╝   ╚═╝    ╚═════╝ ${NC}╚═╝     ╚═╝╚═╝  ╚═══╝  \
         \n                                ╗ made by ${GREEN}Herencia${NC} ╔\
         \n                   Credit: ${YELLOW}Credit for this script to neo3587${NC}\
         \n           Source: ${CYAN}https://github.com/herenciacoin/HEIRS-MultiMN${NC}\		 
         \n====================================================================================\
         \n                                                   "

multimn_update=$(curl -s https://raw.githubusercontent.com/herenciacoin/HEIRS-MultiMN/main/multimn.sh)
